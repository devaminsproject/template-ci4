...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="alert alert-success alert-dismissible">
            ...
            To make right sidebar hidden by default, simply add <code>.sidebar-collapsed</code> class to right sidebar container and keep the toggler somewhere. In this example toggle button is inside main navbar.
...
<!-- Right sidebar -->
<div class="sidebar sidebar-end sidebar-expand-lg sidebar-collapsed align-self-start">
    <!-- Sidebar content -->
    <div class="sidebar-content">
        <!-- Header -->
