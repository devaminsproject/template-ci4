...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="alert alert-success alert-dismissible">
            <div class="alert-heading fw-semibold">Dark sidebar</div>
            All sidebars support light and dark color palettes. By default right sidebar is light, if you want to change background color to dark, simply add <code>.sidebar-dark</code> class to <code>.sidebar-end</code> container.
...
<!-- Right sidebar -->
<div class="sidebar sidebar-dark sidebar-end sidebar-expand-lg">
    ...
    <div class="sidebar-content">
        ...
        <div class="sidebar-section sidebar-section-body d-flex align-items-center pb-2">
            ...
            <div class="ms-auto">
                <button type="button" class="btn btn-flat-white border-transparent btn-icon rounded-pill btn-sm sidebar-mobile-end-toggle d-lg-none">
                    <i class="ph-x"></i>
                </button>
            </div>
        </div>
