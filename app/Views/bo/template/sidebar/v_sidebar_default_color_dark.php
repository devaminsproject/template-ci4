...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="alert alert-success alert-dismissible">
            <div class="alert-heading fw-semibold">Dark main sidebar</div>
            All sidebars support light and dark color palettes. By default main sidebar is light, if you want to make it dark, add <code>.sidebar-dark</code> class to sidebar container. Some text color adjustments might be needed.
