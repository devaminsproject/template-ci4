<!-- Secondary sidebar -->
<div class="sidebar sidebar-secondary sidebar-dark sidebar-expand-lg align-self-start">
    ...
    <div class="sidebar-content">
        ...
        <div class="sidebar-section sidebar-section-body d-flex align-items-center pb-2">
            ...
            <div class="ms-auto">
                <button type="button" class="btn btn-flat-white border-transparent btn-icon rounded-pill btn-sm sidebar-mobile-secondary-toggle d-lg-none">
                    <i class="ph-x"></i>
                </button>
            </div>
        </div>
        ...
        <div class="sidebar-section">
            <div class="sidebar-section-header border-bottom border-white border-opacity-10">
        ...
        <div class="sidebar-section">
            ...
            <div class="collapse show" id="sidebar-actions">
                <div class="sidebar-section-body">
                    <div class="row row-tile g-0" data-color-theme="dark">
                        <div class="col">
        ...
        <div class="sidebar-section">
            ...
            <div class="collapse show" id="sidebar-users">
                <div class="sidebar-section-body" data-color-theme="dark">
...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="alert alert-success alert-dismissible">
            <div class="alert-heading fw-semibold">Dark secondary sidebar</div>
            All sidebars support light and dark color palettes. By default secondary sidebar is light, if you want to change background color to dark, simply add <code>.sidebar-dark</code> class to the base <code>.sidebar-secondary</code> container.
