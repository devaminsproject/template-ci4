<!-- Secondary sidebar -->
<div class="sidebar sidebar-secondary sidebar-expand-lg sidebar-collapsed align-self-start">
...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="alert alert-success alert-dismissible">
            <div class="alert-heading fw-semibold">Hidden secondary sidebar</div>
            To make secondary sidebar hidden by default, simply add <code>.sidebar-collapsed</code> class to secondary sidebar container and keep the toggler somewhere.
