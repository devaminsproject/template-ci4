...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p class="mb-3">
                    By default, all navigation links have padding and background color, but don't have rounded corners. This can be controlled with our border radius utility classes, just add <code>.rounded</code> or
                    <code>.rounded-[1|2|3|4|5]</code> classes to the base <code>.navbar-nav-link</code> element. Make sure you also have vertical spacing in navbar container. All links with icons only are displayed as squares with equal width
                    and height.
                </p>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p class="mb-3">
                    To make navigation links fully rounded, add <code>.rounded-pill</code> to each <code>.navbar-nav-link</code> element. Links with text are displayed as pills in this case and links with icons only are equally proportional
                    (height = width). This logic also works in all navbar sizes. Edit <code>$navbar-link-padding-[x|y]</code> or <code>--navbar-link-padding-[x|y]</code> variables to change the default links size. Inner navbar spacing is
                    controlled via padding utility classes.
                </p>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p class="mb-3">
                    Background color in navigation links can be disabled by adding <code>.bg-transparent</code> utility class. If you have links inside <code>.navbar-collapse</code> container that stack on mobile, you can control left and right
                    padding on desktop and mobile separately with our responsive utility classes. In the examples below we use <code>.px-0.px-[breakpoint]-2</code>. If outside collapsible container, no padding adjustments are necessary.
                </p>
