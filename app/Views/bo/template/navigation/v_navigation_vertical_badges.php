    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Nav item badges</h5>
            </div>

            <div class="card-body">
                <p class="mb-3">Badges are awesome. If you need to add a counter, resolution, status, stamp or any other short information to your navigation item, simply add <code>badge</code> component markup after nav link text along with <code>.ms-auto</code> class to stick it to the right. Since <code>.nav-link</code> is based on flexbox, you can use utility classes to adjust spacing and ordering. All navigation types, styles and all navigation levels support badge component. Thanks to SASS, badge color in <code>active</code> state changes dynamically and depends on color lightness.</p>
                                ...
                                <div class="sidebar-section">
                                    <ul class="nav nav-sidebar" data-nav-type="accordion">
                                        <li class="nav-item-header">
                                            <div class="text-uppercase fs-sm lh-sm opacity-50">Sidebar header</div>
                                        </li>
                                        ...
                                        <li class="nav-item">
                                            <a href="#" class="nav-link active">
                                                ...
                                                Active link
                                                <span class="badge bg-teal ms-auto">New</span>
                                            </a>
                                        </li>
                                        ...
                                        <li class="nav-item">
                                            <a href="#" class="nav-link">
                                                ...
                                                Top level link
                                                <span class="badge bg-pink rounded-pill ms-auto">39</span>
                                            </a>
                                        </li>
                                        ...
                                        <li class="nav-item nav-item-submenu">
                                            <a href="#" class="nav-link">
                                                <i class="ph-pencil"></i>
                                                With children
                                                <span class="badge text-reset ms-auto">Pending</span>
                                            </a>
                                        ...
                                        <li class="nav-item nav-item-submenu">
                                            <a href="#" class="nav-link">
                                                ...
                                                Multiple levels
                                                <span class="badge border border-primary text-primary rounded-pill ms-auto">40</span>
                                            </a>
                                            ...
                                            <ul class="nav-group-sub collapse">
                                                ...
                                                <li class="nav-item nav-item-submenu">
                                                    <a href="#" class="nav-link">
                                                        ...
                                                        <span class="badge bg-danger ms-auto">Bug</span>
                                                    </a>
                                                    <ul class="nav-group-sub collapse">
                                                        <li class="nav-item">
                                                            <a href="#" class="nav-link">
                                                                Third level
                                                                <span class="badge bg-purple rounded-pill ms-auto">39</span>
                                                            </a>
                                                        </li>
                                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item nav-item-submenu">
                                            <a href="#" class="nav-link disabled">
                                                ...
                                                Disabled levels
                                                <span class="badge bg-secondary ms-auto">Fixed</span>
                                            </a>
