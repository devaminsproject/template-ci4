...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p class="mb-3">
                    Disabled state of vertical sidebar navigation is controlled by JS code located in <code>app.js</code> file - it disables click action in single nav item and submenu. Styles of disabled state are defined in SASS and can be
                    easily changed in a set of variables. To disable single item or submenu with icons, add <code>.disabled</code> to any <code>.nav-link</code> element. If this element is inside <code>.nav-item-submenu</code> container,
                    children list of nav items that comes right after nav link won't be collapsible.
                </p>
