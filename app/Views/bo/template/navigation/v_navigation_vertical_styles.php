...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="alert alert-success alert-dismissible">
            <div class="alert-heading fw-semibold">Accordion navigation type</div>
            Change <strong>collapsible</strong> navigation type to <strong>accordion</strong> by changing <code> data-nav-type="collapsible"</code> data attribute to <code> data-nav-type="accordion"</code> in main <code>.nav-sidebar</code> container.
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="sidebar sidebar-expand w-100 border shadow-none rounded mb-lg-4">
                            <div class="sidebar-content">
                                ...
                                <div class="sidebar-section">
                                    <ul class="nav nav-sidebar nav-sidebar-sm px-2 mx-1" data-nav-type="accordion">
                                        <li class="nav-item-header">
                                            <div class="text-uppercase fs-sm lh-sm opacity-50">Navigation header</div>
                                        </li>

                                        <li class="nav-item">
                                            <a href="#" class="nav-link rounded active">
                                        ...
                                        <li class="nav-item nav-item-submenu">
                                            ...
                                            <ul class="nav-group-sub collapse">
                                                <li class="nav-item">
                                                    <a href="#" class="nav-link rounded">Second level</a>
                                                </li>
                                                <li class="nav-item nav-item-submenu">
                                                    <a href="#" class="nav-link rounded">Second level with child</a>
                                                    <ul class="nav-group-sub collapse">
                                                        <li class="nav-item">
                                                            <a href="#" class="nav-link rounded">Third level</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a href="#" class="nav-link rounded">Third level</a>
                                                        </li>
                                        ...
                                        <li class="nav-item nav-item-submenu">
                                            <a href="#" class="nav-link rounded disabled">
                                            ...
                                            <ul class="nav-group-sub collapse">
                                                <li class="nav-item">
                                                    <a href="#" class="nav-link rounded">Second level link</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="#" class="nav-link rounded">Second level link</a>
                                                </li>
                        ...
                        <div class="sidebar sidebar-expand w-100 border shadow-none rounded mb-lg-4">
                            <div class="sidebar-content">
                                ...
                                <!-- Navigation -->
                                <div class="sidebar-section">
                                    <ul class="nav nav-sidebar nav-sidebar-sm pe-2 me-1" data-nav-type="accordion">
                                        <li class="nav-item-header">
                                            <div class="text-uppercase fs-sm lh-sm opacity-50">Navigation header</div>
                                        </li>

                                        <li class="nav-item">
                                            <a href="#" class="nav-link rounded-end-pill active">
                                                <i class="ph-plus-circle"></i>
                                                Active link
                                            </a>
                                        </li>
                                        ...
                                        <li class="nav-item">
                                            <a href="#" class="nav-link rounded-end-pill">
                                                <i class="ph-circles-three-plus"></i>
                                                Top level link
                                            </a>
                                        </li>
                                        ...
                                        <li class="nav-item nav-item-submenu">
                                            ...
                                            <ul class="nav-group-sub collapse">
                                                <li class="nav-item">
                                                    <a href="#" class="nav-link rounded-end-pill">Second level</a>
                                                </li>
                                                <li class="nav-item nav-item-submenu">
                                                    <a href="#" class="nav-link rounded-end-pill">Second level with child</a>
                                                    <ul class="nav-group-sub collapse">
                                                        <li class="nav-item">
                                                            <a href="#" class="nav-link rounded-end-pill">Third level</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a href="#" class="nav-link rounded-end-pill">Third level</a>
                                                        </li>
                                        ...
                                        <li class="nav-item nav-item-submenu">
                                            <a href="#" class="nav-link rounded-end-pill disabled">
                                                <i class="ph-users-three"></i>
                                                Disabled levels
                                            </a>
                                            ...
                                            <ul class="nav-group-sub collapse">
                                                <li class="nav-item">
                                                    <a href="#" class="nav-link rounded-end-pill">Second level link</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="#" class="nav-link rounded-end-pill">Second level link</a>
                                                </li>
                    ...
                    <div class="col-lg-6">
                        <p class="fw-semibold">Accordion type:</p>
                        <div class="sidebar sidebar-expand w-100 border shadow-none rounded mb-lg-4">
                            <div class="sidebar-content">
                                ...
                                <div class="sidebar-section">
                                    <ul class="nav nav-sidebar nav-sidebar-sm px-2 mx-1" data-nav-type="accordion">
                                        ...
                                        <li class="nav-item nav-item-submenu">
                                            ...
                                            <ul class="nav-group-sub collapse">
                                                <li class="nav-item">
                                                    <a href="#" class="nav-link rounded-pill">Second level</a>
                                                </li>
                                                <li class="nav-item nav-item-submenu">
                                                    <a href="#" class="nav-link rounded-pill">Second level with child</a>
                                                    <ul class="nav-group-sub collapse">
                                                        <li class="nav-item">
                                                            <a href="#" class="nav-link rounded-pill">Third level</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a href="#" class="nav-link rounded-pill">Third level</a>
                                                        </li>
                                        ...
                                        <li class="nav-item nav-item-submenu">
                                            <a href="#" class="nav-link rounded-pill disabled">
                                                <i class="ph-users-three"></i>
                                                Disabled levels
                                            </a>
                                            ...
                                            <ul class="nav-group-sub collapse">
                                                <li class="nav-item">
                                                    <a href="#" class="nav-link rounded-pill">Second level link</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="#" class="nav-link rounded-pill">Second level link</a>
                                                </li>
                        ...
                        <div class="sidebar sidebar-expand w-100 border shadow-none rounded mb-lg-4">
                            <div class="sidebar-content">
                                ...
                                <!-- Navigation -->
                                <div class="sidebar-section">
                                    <ul class="nav nav-sidebar nav-sidebar-sm ps-2 ms-1" data-nav-type="accordion">
                                        <li class="nav-item-header">
                                            <div class="text-uppercase fs-sm lh-sm opacity-50">Navigation header</div>
                                        </li>

                                        <li class="nav-item">
                                            <a href="#" class="nav-link rounded-start-pill active">
                                                <i class="ph-plus-circle"></i>
                                                Active link
                                            </a>
                                        </li>
                                        ...
                                        <li class="nav-item">
                                            <a href="#" class="nav-link rounded-start-pill">
                                                <i class="ph-circles-three-plus"></i>
                                                Top level link
                                            </a>
                                        </li>
                                        ...
                                        <li class="nav-item nav-item-submenu">
                                            ...
                                            <ul class="nav-group-sub collapse">
                                                <li class="nav-item">
                                                    <a href="#" class="nav-link rounded-start-pill">Second level</a>
                                                </li>
                                                <li class="nav-item nav-item-submenu">
                                                    <a href="#" class="nav-link rounded-start-pill">Second level with child</a>
                                                    <ul class="nav-group-sub collapse">
                                                        <li class="nav-item">
                                                            <a href="#" class="nav-link rounded-start-pill">Third level</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a href="#" class="nav-link rounded-start-pill">Third level</a>
                                                        </li>
                                        ...
                                        <li class="nav-item nav-item-submenu">
                                            <a href="#" class="nav-link rounded-start-pill disabled">
                                                <i class="ph-users-three"></i>
                                                Disabled levels
                                            </a>
                                            ...
                                            <ul class="nav-group-sub collapse">
                                                <li class="nav-item">
                                                    <a href="#" class="nav-link rounded-start-pill">Second level link</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="#" class="nav-link rounded-start-pill">Second level link</a>
                                                </li>
