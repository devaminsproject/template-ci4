    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Icons alignment</h5>
            </div>

            <div class="card-body">
                <p class="mb-3">
                    Vertical navigation can have 3 options: <strong>no-icons</strong> - boring list with horizontal spacing in all levels; <strong>left icons</strong> - since we read from left-to-right (right-to-left for RTL folks), this is the
                    default option as we understand visual stuff faster than we read text; <strong>right icons</strong> - if icons are not that important, but you still want to show them in less notable mode, this option might be useful. To
                    reverse icons alignment, add <code>.nav-sidebar-icons-reverse</code> class to main sidebar nav container.
                </p>

                <div class="row">
                    <div class="col-lg-6">
                        <p class="fw-semibold">Left aligned icons:</p>
                                ...
                                <div class="sidebar-section sidebar-section-body">
                                    <div class="d-flex justify-content-center">
                                        ...
                                        <div class="flex-fill ms-3">
                                            ...
                                            <div class="fs-sm lh-1 opacity-50 mt-1">Senior developer</div>
                                        </div>
                    ...
                    <div class="col-lg-6">
                        <p class="fw-semibold">Right aligned icons:</p>
                        <div class="sidebar sidebar-expand w-100 border shadow-none rounded mb-lg-4">
                            <div class="sidebar-content">
                                <!-- User menu -->
                                <div class="sidebar-section sidebar-section-body">
        ...
        <div class="card">
            ...
            <div class="card-body">
                This table contains all classes related to the vertical sidebar navigation. Vertical navigation is a custom layout element that uses global <code>nav</code> component classes and adapted for main navigation purposes. Depending
                on the needs, it supports different options such as collapsing type, icons, badges, combination with other sidebar components etc. This list explains the logic and purpose:
            </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                Targets optional <code>header</code> element for separating group of nav items. In main sidebar this class is responsible for toggling text in folded sidebar mode. Use text utility classes to style inner content.
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                This class is required as an immediate nav link parent in any <code>.nav</code> container. Since active link color is different from hover and initial states color, <code>.nav-item</code> has 1px vertical spacing to
                                separate items that have same background color. Dropdown menu items have same logic.
                            </td>
                        </tr>
                        <tr>
                            <td><code>.nav-link</code></td>
                            <td>
                                This class is responsible for navigation link styling and is also required as a part of nav list class structure. It's also a target for <code>.active</code> and <code>disabled</code> states. Please note - this class
                                doesn't reset <code>&lt;button></code> styles, so make sure you use <code>&lt;a></code> instead.
                            </td>
                        </tr>
                        <tr>
                            <td><code>.nav-link.active</code></td>
                            <td>
                                Combination of these classes in a single <code>&lt;a></code> element highlights nav item link and indicates the current page. By default, expanded submenu and <code>active</code> item state color is the same in each
                                level.
                            </td>
                        </tr>
                        <tr>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="mb-3">
                    Flexible template functionality offers 2 different kinds of navigation: collapsible and accordion. Both have custom JS code and provide extended control over the child nav items. Default type is
                    <code>collapsible</code> navigation: open as many child levels as you want, they all will be visible all the time. Second type is <code>accordion</code> navigation: allows to display only 1 parent level, collapsing all
                    others. Both navigation types have hidden 2nd level in mini sidebar that opens on hover/focus.
                </p>
                ...
                <p class="mb-3">
                    Sidebar navigation supports icons in all menu levels. Default icons alignment is left, default visual hierarchy is: icon > text > arrow, adding <code>.nav-sidebar-icons-reverse</code> class to
                    <code>.nav-sidebar</code> container changes it to text > icon > arrow. But despite the default layout, icons are completely optional, so feel free to remove icons markup from the nav links if for some reason you don't need
                    them.
                </p>
                ...
                <h6>Other options</h6>
                <p class="mb-3">
                    Default navigation menu doesn't have any horizontal borders. But you can easily change this behaviour just by adding <code>.nav-sidebar-bordered</code> class to the main <code>.nav-sidebar</code> container. You can also use
                    additional components - such as badges, badge pills, extra text or icons - within <code>.nav-link</code>. But for proper vertical and horizontal alignment you need to use flexbox utility classes and extra containers. See the
                    example with badges.
                </p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <pre class="language-markup mb-3 mb-lg-0" data-line="6-9, 16-19">
									<code>
										&lt;!-- Badges -->
										&lt;ul class="nav nav-sidebar" data-nav-type="accordion">
											&lt;li class="nav-item">
											...
											&lt;li class="nav-item">
												&lt;a href="#" class="nav-link">
													...
													&lt;span class="d-flex align-items-center">
														...
														&lt;span class="badge badge-primary badge-pill ml-auto">32&lt;/span>
													&lt;/span>
												&lt;/a>
											&lt;/li>
										&lt;/ul>
