...
<div class="sidebar sidebar-secondary sidebar-expand-lg align-self-start">
    ...
    <div class="sidebar-content">
        ...
        <!-- Header -->
        <div class="sidebar-section sidebar-section-body d-flex align-items-center pb-1">
                        ...
                        <table class="table text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-block me-3">
                                                <img src="<?= base_url('assets/bo/images/brands/facebook.svg'); ?>" class="rounded-circle" width="36" height="36" alt="" />
                                            </a>
                                            <div>
                                    ...
                                    <td>
                                        <span class="text-success"><i class="ph-trend-up me-2"></i> 2.43%</span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-block me-3">
                                                <img src="<?= base_url('assets/bo/images/brands/youtube.svg'); ?>" class="rounded-circle" width="36" height="36" alt="" />
                                            </a>
                                            <div>
                                    ...
                                    <td>
                                        <span class="text-success"><i class="ph-trend-up me-2"></i> 3.12%</span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-block me-3">
                                                <img src="<?= base_url('assets/bo/images/brands/spotify.svg'); ?>" class="rounded-circle" width="36" height="36" alt="" />
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-block me-3">
                                                <img src="<?= base_url('assets/bo/images/brands/twitter.svg'); ?>" class="rounded-circle" width="36" height="36" alt="" />
                                            </a>
                                            <div>
                                    ...
                                    <td>
                                        <span class="text-success"><i class="ph-trend-up me-2"></i> 2.78%</span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-block me-3">
                                                <img src="<?= base_url('assets/bo/images/brands/bing.svg'); ?>" class="rounded-circle" width="36" height="36" alt="" />
                                            </a>
                                            <div>
                                    ...
                                    <td>
                                        <span class="text-danger"><i class="ph-trend-down me-2"></i> 5.78%</span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-block me-3">
                                                <img src="<?= base_url('assets/bo/images/brands/amazon.svg'); ?>" class="rounded-circle" width="36" height="36" alt="" />
                                            </a>
                                            <div>
                                    ...
                                    <td>
                                        <span class="text-success"><i class="ph-trend-up me-2"></i> 6.79%</span>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-block me-3">
                                                <img src="<?= base_url('assets/bo/images/brands/dribbble.svg'); ?>" class="rounded-circle" width="36" height="36" alt="" />
                                            </a>
                                            <div>
                                    ...
                                    <td>
                                        <span class="text-danger"><i class="ph-trend-down me-2"></i> 9.83%</span>
                                    </td>
                                    <td>
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="<?= base_url('assets/bo/images/demo/users/face15.jpg'); ?>" class="rounded-circle" width="40" height="40" alt="" />
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="<?= base_url('assets/bo/images/demo/users/face3.jpg'); ?>" class="rounded-circle" width="40" height="40" alt="" />
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="<?= base_url('assets/bo/images/demo/users/face8.jpg'); ?>" class="rounded-circle" width="40" height="40" alt="" />
                                            </a>
                                            <div>
                    ...
                    <div class="card-body pb-0">
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="d-sm-flex align-items-sm-start mb-3">
                                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                        <img src="<?= base_url('assets/bo/images/demo/flat/1.png'); ?>" class="flex-shrink-0 rounded" height="100" alt="" />
                                ...
                                <div class="d-sm-flex align-items-sm-start mb-3">
                                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                        <img src="<?= base_url('assets/bo/images/demo/flat/21.png'); ?>" class="flex-shrink-0 rounded" height="100" alt="" />
                                        <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                                            <i class="ph-play"></i>
                                        </div>
                            ...
                            <div class="col-xl-6">
                                <div class="d-sm-flex align-items-sm-start mb-3">
                                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                        <img src="<?= base_url('assets/bo/images/demo/flat/12.png'); ?>" class="flex-shrink-0 rounded" height="100" alt="" />
                                        <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                                            <i class="ph-play"></i>
                                        </div>
                                ...
                                <div class="d-sm-flex align-items-sm-start mb-3">
                                    <a href="#" class="d-inline-block position-relative me-sm-3 mb-3 mb-sm-0">
                                        <img src="<?= base_url('assets/bo/images/demo/flat/18.png'); ?>" class="flex-shrink-0 rounded" height="100" alt="" />
                                        <div class="d-inline-flex bg-dark bg-opacity-50 text-white position-absolute start-50 top-50 translate-middle rounded-pill p-2">
                                            <i class="ph-play"></i>
                                        </div>
            ...
            <div class="col-xl-4">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="<?= base_url('assets/bo/images/demo/logos/1.svg'); ?>" alt="" height="36" />
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="<?= base_url('assets/bo/images/demo/logos/2.svg'); ?>" alt="" height="36" />
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="<?= base_url('assets/bo/images/demo/logos/3.svg'); ?>" alt="" height="36" />
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="d-inline-block me-3">
                                                <img src="<?= base_url('assets/bo/images/demo/logos/4.svg'); ?>" alt="" height="36" />
                                            </a>
                                            <div>
                ...
                <div class="card">
                    ...
                    <ul class="nav nav-tabs nav-tabs-underline nav-justified">
                        <li class="nav-item">
                            <a href="#messages-tue" class="nav-link active" data-bs-toggle="tab"> Tuesday </a>
                        </li>

                        <li class="nav-item">
                            <a href="#messages-mon" class="nav-link" data-bs-toggle="tab"> Monday </a>
                        </li>

                        <li class="nav-item">
                            <a href="#messages-fri" class="nav-link" data-bs-toggle="tab"> Friday </a>
                        </li>
                    </ul>
                    <!-- /tabs -->
                    ...
                    <div class="tab-content card-body">
                        <div class="tab-pane active fade show" id="messages-tue">
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="<?= base_url('assets/bo/images/demo/users/face10.jpg'); ?>" class="rounded-circle" width="40" jeight="40" alt="" />
                            ...
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="<?= base_url('assets/bo/images/demo/users/face3.jpg'); ?>" class="rounded-circle" width="40" jeight="40" alt="" />
                            ...
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="<?= base_url('assets/bo/images/demo/users/face24.jpg'); ?>" class="rounded-circle" width="40" jeight="40" alt="" />
                                    <span class="status-indicator bg-danger"></span>
                                </div>
                            ...
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="<?= base_url('assets/bo/images/demo/users/face4.jpg'); ?>" class="rounded-circle" width="40" jeight="40" alt="" />
                                    <span class="status-indicator bg-danger"></span>
                                </div>
                            ...
                            <div class="d-flex align-items-start">
                                <div class="status-indicator-container me-3">
                                    <img src="<?= base_url('assets/bo/images/demo/users/face25.jpg'); ?>" class="rounded-circle" width="40" jeight="40" alt="" />
                                    <span class="status-indicator bg-success"></span>
                                </div>
                        ...
                        <div class="tab-pane fade" id="messages-mon">
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="<?= base_url('assets/bo/images/demo/users/face2.jpg'); ?>" class="rounded-circle" width="40" jeight="40" alt="" />
                                    <span class="status-indicator bg-success"></span>
                                </div>
                            ...
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="<?= base_url('assets/bo/images/demo/users/face7.jpg'); ?>" class="rounded-circle" width="40" jeight="40" alt="" />
                            ...
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="<?= base_url('assets/bo/images/demo/users/face18.jpg'); ?>" class="rounded-circle" width="40" jeight="40" alt="" />
                                    <span class="status-indicator bg-warning"></span>
                                </div>
                            ...
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="<?= base_url('assets/bo/images/demo/users/face14.jpg'); ?>" class="rounded-circle" width="40" jeight="40" alt="" />
                                    <span class="status-indicator bg-success"></span>
                                </div>
                            ...
                            <div class="d-flex align-items-start">
                                <div class="status-indicator-container me-3">
                                    <img src="<?= base_url('assets/bo/images/demo/users/face8.jpg'); ?>" class="rounded-circle" width="40" jeight="40" alt="" />
                                    <span class="status-indicator bg-success"></span>
                                </div>
                        ...
                        <div class="tab-pane fade" id="messages-fri">
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="<?= base_url('assets/bo/images/demo/users/face15.jpg'); ?>" class="rounded-circle" width="40" jeight="40" alt="" />
                                    <span class="status-indicator bg-danger"></span>
                                </div>
                            ...
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="<?= base_url('assets/bo/images/demo/users/face12.jpg'); ?>" class="rounded-circle" width="40" jeight="40" alt="" />
                                    <span class="status-indicator bg-warning"></span>
                                </div>
                            ...
                            <div class="d-flex align-items-start mb-3">
                                <div class="status-indicator-container me-3">
                                    <img src="<?= base_url('assets/bo/images/demo/users/face22.jpg'); ?>" class="rounded-circle" width="40" jeight="40" alt="" />
                                    <span class="status-indicator bg-danger"></span>
                                </div>
                            ...
                            <div class="d-flex align-items-start">
                                <div class="status-indicator-container me-3">
                                    <img src="<?= base_url('assets/bo/images/demo/users/face17.jpg'); ?>" class="rounded-circle" width="40" jeight="40" alt="" />
                                    <span class="status-indicator bg-secondary"></span>
                                </div>
...
<div class="sidebar sidebar-end sidebar-expand-lg align-self-start">
    ...
    <div class="sidebar-content">
        ...
        <!-- Header -->
        <div class="sidebar-section sidebar-section-body d-flex align-items-start pb-1">
