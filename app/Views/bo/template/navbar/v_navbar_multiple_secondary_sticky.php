...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="alert alert-success alert-dismissible">
            ...
            Secondary navbar can be sticked to the top or bottom when scroll position reaches the component, so that it doesn't scroll away with the content, but always stays on top. Just add <code>.sticky-top</code> class to
            <code>.navbar</code> container and CSS will do the rest. No JS required.
