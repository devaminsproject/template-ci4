...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p class="mb-4">
                    In some cases you might need a complex component that consists of multiple rows. This is where multiple content navbars can be useful. Basically 2 or more navbars can be easily used together, if one comes after another and
                    navbar containers have corresponding class names. Optionally you can add <code>.rounded-top</code> and <code>.rounded-bottom</code> classes to the first and last navbars accordingly. Additionally, since navbar component has
                    bottom margin, you need to add <code>.mb-0</code> class to all navbars except the last one. Use other utility classes for additional adjustments.
                </p>
                ...
                <div class="mb-4">
                    ...
                    <p class="mb-3">
                        You can combine default <code>dark</code> navbar color with custom colors just by adding <code>.bg-[color]</code> class to the navbar container. As always, all navbar content is adjusted accordingly. You can also use
                        <code>border</code> utility classes to control vertical and horizontal borders stacking.
                    </p>
                ...
                <div class="mb-4">
                    ...
                    <p class="mb-3">
                        Light navbar have <strong>white</strong> background color by default defined in <code>$navbar-light-bg</code> variable. You can use additional light color classes from color system: <code>.bg-light</code> for light grey
                        color, <code>.bg-[color].bg-opacity-10</code> for other light colors. In some cases stacked light navbars require border color or width adjustments, use <code>border</code> utility classes to control border styles.
                    </p>
                ...
                <div class="mb-4">
                    <h6>Mixing colors</h6>
                    <p class="mb-3">
                        Thanks to color helper classes, <code>background</code> and <code>border</code> utility classes you can easily mix background colors in multiple content navbars. The example below demonstrates <strong>dark</strong> teal
                        and <strong>white</strong> navbars, but you can mix up colors without any limits: dark/white, white/dark, white/alphas, alphas/dark etc. Check out all available colors <a href="colors_primary.html">here</a>.
                    </p>
                ...
                <p class="mb-3">
                    Navbar component markup is similar to default navbar markup. But in most cases navbar component doesn't use <code>.navbar-brand</code> container that occupies left navbar side, since content navbar has slightly different
                    purpose and doesn't need brand logo. Use border and margin helper classes to add bottom spacing and borders, and <code>.rounded</code> class to make it rounded. Navbar component supports all available navbar styling and
                    sizing options, including all navbar components.
                </p>
