...
<div class="content-wrapper">
    ...
    <div class="content">
        ...
        <div class="alert alert-success alert-dismissible">
            ...
            Bottom <code>fixed</code> navbar is positioned relatively to the screen's viewport and doesn't move when scrolled. To use, add <code>.fixed-bottom</code> class to the <code>.navbar</code> container and
            <code>.navbar-bottom</code> class to the <code>&lt;body&gt;</code> container.
        ...
        <div class="card">
            ...
            <div class="card-body">
                <p class="mb-3">
                    ...
                    You can also control responsive collapsing breakpoint directly in the markup. Navbar component is responsive by default and requires <code>.navbar</code> and <code>.navbar-expand{-sm|-md|-lg|-xl|-xxl}</code> classes. Main
