...
<?php if ((isset($multipleFooter) ? $multipleFooter : 1) == 0) { ?>
    <div class="<?= isset($footer) ? $footer : ''; ?>">
        <!-- Alternative navbar -->
                ...
                <div class="flex-fill">
                    ...
                    <div class="d-flex my-2">
                        <a href="#" class="status-indicator-container me-1">
                            <img src="<?= base_url('assets/bo/images/demo/users/face10.jpg'); ?>" class="w-32px h-32px rounded-pill" alt="" />
                        ...
                        <a href="#" class="status-indicator-container me-1">
                            <img src="<?= base_url('assets/bo/images/demo/users/face12.jpg'); ?>" class="w-32px h-32px rounded-pill" alt="" />
                            <span class="status-indicator bg-success"></span>
                        </a>
                        <a href="#" class="status-indicator-container me-1">
                            <img src="<?= base_url('assets/bo/images/demo/users/face13.jpg'); ?>" class="w-32px h-32px rounded-pill" alt="" />
                            <span class="status-indicator bg-success"></span>
                        </a>
                ...
                <div class="flex-fill">
                    ...
                    <div class="bg-light rounded p-2 my-2">
                        <div class="d-flex align-items-center">
                            <div class="me-2">
                                <img src="<?= base_url('assets/bo/images/icons/pdf.svg'); ?>" width="34" height="34" alt="" />
                            </div>
                            <div class="flex-fill">
                                new_contract.pdf
